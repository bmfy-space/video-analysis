<template>
  <div class="shadow-sm">
    <div class="max-w-screen-lg mx-auto py-3 flex items-center ">
      <div class="w-6 h-6 mr-2 text-primary">
      ...
      <h3 class="font-bold text-2xl text-primary">Video Analysis</h3>
      <div class="ml-auto">
        <ul class="flex space-x-3 text-sm">
          ...
          <li class="hover:text-primary">
            <nuxt-link to="/">Tutorials</nuxt-link>
          </li>
        </ul>
      </div>
  </div>
